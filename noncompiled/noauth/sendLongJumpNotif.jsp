...
<%@page import="net.reliableresponse.notification.sender.LongJumpCTISender"%>
...
String responsesString = (String)request.getParameter("responses");
System.out.println ("responses = "+responsesString);
String[] responses = responsesString.split("[\\n,]");
...
if (user == null) {
	...
	System.out.println ("Adding user with LongJump UUID: "+objectID+":"+recordID);
...
LongJumpCTISender sender = new LongJumpCTISender();
sender.setResponses(responses);
